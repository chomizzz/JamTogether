    ...
    return (
        <table className="table-auto w-full border-separate border-4 border-slate-500">
            ...
            <tr>
                ...
                <th className="border border-slate-600 border-2">Players</th>
                <th className="border border-slate-600 border-2">Spectators</th>
            ...
            <tr key={room.id}> {/* Ajouter une clé unique ici pour chaque ligne */}
                ...
                <td className="border border-slate-600 border-2">
                    {room.currentPlayerNumber} / {room.maxPlayer}
                </td>
                <td className="border border-slate-600 border-2">
                    {room.currentSpectatorNumber} / 20
                </td>
